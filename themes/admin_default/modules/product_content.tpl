            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        <!-- Tên sản phẩm -->
                        <tr>
                            <td class="text-right align-middle">{LANG.prod_name} <sup class="required">(*)</sup></td>
                            <td>
                                <input type="text" class="form-control" name="name" id="inputName" value="{FORM_DATA.name}" placeholder="{LANG.prod_name}">
                            </td>
                        </tr>
                        ...
                        <!-- danh mục sp -->
                        <tr>
                            <td class="text-right align-middle">{LANG.cate_list} <sup class="required">(*)</sup></td>
                            <td>
                                <select name="cate_id" id="cateSelect" class="select2 w400 form-control">
                                    <!-- BEGIN: cate_option -->
                                    {CATE_OPTION}
                                    <!-- END: cate_option -->
                                </select>
                        ...
                        <!-- giá cả -->
                        <tr>
                            <td class="text-right align-middle">{LANG.price} <sup class="required">(*)</sup></td>
                            <td>
                                <input type="number" class="w300 form-control pull-left" name="price" id="inputPrice" maxlength="8" value="{FORM_DATA.price}" placeholder="{LANG.price}">
                                <label for="price" class="control-label" style="padding: 10px 0px 0px 10px;">({LANG.currency.0})</label>
                            </td>
                        </tr>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('body').on('keyup', '#inputName', function(event) {
